...
public class SubmitFeedBackDialog extends Dialog {
    private String submitStatus;//提示语
     ...
     */
    public SubmitFeedBackDialog(Context context, String submitStatus, String confirmText, int imgResId) {
    ...
    public SubmitFeedBackDialog(Context context, String submitStatus, String confirmText, int imgResId,String submitRemind) {
        super(context, R.style.RemindDialog);
        this.context = context;
        this.imgResId = imgResId;
        this.submitStatus = submitStatus;
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.submit_remind_dialog, null);
        setContentView(view);
