...
//    private String remindString = "";
    ...
    public RePortShareDialog(Context context, String remindString) {
        super(context);
//        this.remindString = remindString;
        init(context);
    }

    protected RePortShareDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init(context);
    }

    public RePortShareDialog(Context context, int themeResId) {
