package com.orientdata.lookforcustomers.widget.toggleButton.zcw.togglebutton;
...
import com.orientdata.lookforcustomers.widget.toggleButton.facebook.rebound.SimpleSpringListener;
import com.orientdata.lookforcustomers.widget.toggleButton.facebook.rebound.Spring;
import com.orientdata.lookforcustomers.widget.toggleButton.facebook.rebound.SpringConfig;
import com.orientdata.lookforcustomers.widget.toggleButton.facebook.rebound.SpringSystem;
import com.orientdata.lookforcustomers.widget.toggleButton.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View {
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#0077FF");//#00a0e9 蓝色   #4ebb7f 绿色  #53d2b0
	/** 关闭颜色*/
