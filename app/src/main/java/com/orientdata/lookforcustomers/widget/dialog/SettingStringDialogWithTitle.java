 ...
 */
public class SettingStringDialogWithTitle extends Dialog{
    //点击监听
...
//    private String remindString = "";
    ...
    public SettingStringDialogWithTitle(Context context, String remindString) {
        super(context);
//        this.remindString = remindString;
        init(context);
    }

    protected SettingStringDialogWithTitle(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init(context);
    }

    public SettingStringDialogWithTitle(Context context, int themeResId) {
    ...
    private void init(Context context) {
        ...
        setContentView(R.layout.string_dialog_with_title);
        //设置弹出窗口的位置
        setWindow();
        setUpViews();
        setUpListener();
