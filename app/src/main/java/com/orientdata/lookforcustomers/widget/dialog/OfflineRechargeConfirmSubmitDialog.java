...
public class OfflineRechargeConfirmSubmitDialog extends Dialog {
     ...
     * @param context
     */
    public OfflineRechargeConfirmSubmitDialog(Context context, String remindString) {
        super(context, R.style.RemindDialog);
        this.context = context;
        this.remindString = remindString;
    }
    public OfflineRechargeConfirmSubmitDialog(Context context, String remindTitle, String remindString) {
        super(context, R.style.RemindDialog);
        this.context = context;
        this.remindString = remindString;
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.offline_recharge_confirm_submit_dialog, null);
        setContentView(view);
