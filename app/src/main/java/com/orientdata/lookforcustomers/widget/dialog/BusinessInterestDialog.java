 ...
 * 商业兴趣一级
 */
public class BusinessInterestDialog extends Dialog{
    //点击监听
...
//    private String remindString = "";
    ...
    public BusinessInterestDialog(Context context, String remindString) {
        super(context);
//        this.remindString = remindString;
        init(context);
    }

    protected BusinessInterestDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        init(context);
    }

    public BusinessInterestDialog(Context context, int themeResId) {
    ...
    public interface ChangeListener{
        void onChangeListener(List<InterestTagImportOut> data, int position);
    }
...
//        tvChooseRemind.setText(remindString);
    ...
    private List<InterestTagImportOut> data;

    public void setUpData(final List<InterestTagImportOut> datas) {
        this.data = datas;
...
//        data.get(position).setChecked(true);
    ...
    class MyAdapter extends ArrayAdapter<InterestTagImportOut> {
        private List<InterestTagImportOut> datas;
        private Context context;

        public MyAdapter(Context context, int resourceId, List<InterestTagImportOut> datas) {
        ...
        @Override
        public InterestTagImportOut getItem(int position) {
