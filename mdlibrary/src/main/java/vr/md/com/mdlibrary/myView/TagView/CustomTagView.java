...
public class CustomTagView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.word3;
    ...
    private static final int DEFAULT_RIGHT_IMAGE = 0;//不需要图标
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeWidth = View.MeasureSpec.getSize(widthMeasureSpec);
        sizeHeight = View.MeasureSpec.getSize(heightMeasureSpec);
        ...
        setMeasuredDimension(
                sizeWidth,
                (heightMode == View.MeasureSpec.EXACTLY ? sizeHeight : totalHeight));
