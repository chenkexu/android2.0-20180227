package vr.md.com.mdlibrary.myView.TagView;
...
/**
 * Created by Mr.Z on 15/12/25.
 */
public class MemberTagView extends ViewGroup {
    ...
    private static  int DEFAULT_TEXT_BACKGROUND = R.drawable.member_tab_bg;
    private static  int DEFAULT_VIEW_BORDER = 60;//tag间的间隔
    private static  int DEFAULT_TEXT_BORDER_HORIZONTAL =0;//距左距离
    private static  int DEFAULT_TEXT_BORDER_VERTICAL = 30;

    private static  int DEFAULT_TAG_RESID = R.layout.item_member_tag;
    private static  int DEFAULT_RIGHT_IMAGE = R.drawable.arrow_right;
    private static  boolean DEFAULT_SINGLE_LINE = false;
    private static  boolean DEFAULT_SHOW_RIGHT_IMAGE = true;
    private static  boolean DEFAULT_SHOW_END_TEXT = true;
    private static String DEFAULT_END_TEXT_STRING = " … ";
    private static  boolean DEFAULT_CAN_TAG_CLICK = true;

    public MemberTagView(Context context) {
        this(context, null);
    }

    public MemberTagView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MemberTagView(Context context, AttributeSet attrs, int defStyleAttr) {
